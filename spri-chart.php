		...
		<div class="container-fluid">
			...
			<div class="graph_list row">
				<?php foreach ( spri_chart_get_all_graph() as $item ): ?>
					<div id='chart_<?php echo $item->chart_id ?>' class="graph col-xs-6">
						<div class="row">
							...
							<div>
								...
								<script type='text/javascript' id="chart_data_<?php echo $item->chart_id ?>" class='chart_data'>
									var data_<?php echo $item->chart_id ?> = <?php echo $item->chart_data ?>;
								</script>

								<script type='text/javascript' id="chart_option_<?php echo $item->chart_id ?>" class='chart_opt'>
						...
						<div class="row">
							<div class="col-xs-4"><button id="edit_<?php echo $item->chart_id ?>" class="btn btn-primary btn-block" type="button">Edit</button></div>
							<div class="col-xs-4"><button id="update_<?php echo $item->chart_id ?>" class="btn btn-success btn-block" type="button">Update</button></div>
							<div class="col-xs-4"><button id="delete_<?php echo $item->chart_id ?>" class="btn btn-danger btn-block" type="button">Delete</button></div>
						</div>
					</div>
