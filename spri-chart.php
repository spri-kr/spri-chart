...
function spri_chart_admin_menu() {
    $spri_chart_hook = add_menu_page( 'SPRI CHART Manager',
            'SPRI CHART Manager',
            'administrator',
            "spri-chart",
            'spri_chart_draw_admin',
            plugin_dir_url( __FILE__ ) . "/spri.ico" );
...
function spri_chart_load_js() {
    wp_enqueue_script( 'spri-local-js',
            plugins_url( '/src/js/local_js.js', __FILE__ ),
            array( 'jquery' ) );
}
...
function spri_chart_load_lib() {
    ...
    wp_enqueue_script( 'ajax_form_plugin',
            plugins_url( '/src/js/jquery.form.js', __FILE__ ),
            array( 'jquery' ) );

    wp_enqueue_script( 'ace_editor',
            plugins_url( '/src/ace/src-noconflict/ace.js', __FILE__ ),
            array(
                    'jquery',
            ) );
...
/**
 * ajax function processing csv files into json format
 */
...
/**
 * ajax function.
 * insert new chart's data and option into DB
 */
...
/**
 * ajax function
 * update chart's data and option by ajax request
 */
...
/**
 * update chart's status to 'D'eleted.
 */
