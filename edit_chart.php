...
$sql = "select idx, saved_key, chart_title, chart_title, chart_unit, chart_caption, csvfile_relative, excelfile_relative, chart_type from wp_spri_chart_list ";
$sql .= " WHERE state='A'  AND saved_key = $key ";
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-8">
            <h1> Chart Builder (Edition)</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-8">
            <form enctype="multipart/form-data" method="POST" action="edit_chart2.php">
				...
				<textarea name="chart_detailed_option" cols="30"
                    ...
                    <div class="form-group"
                         id="chart_detailed_option"></div>
                </div>

                <div class="form-group">
                    <label for="chart_title">Chart Title </label>
                    <input type="text" class="form-control" name="chart_title" id="chart_title" placeholder="차트 제목" value="<?php echo $chart_title; ?>">
                </div>

                <div class="form-group">
                    <label for="chart_unit">Unit (차트 상단) </label>
                    <input type="text" class="form-control" name="chart_unit" id="chart_unit" placeholder="Unit" value="<?php echo $chart_unit; ?>">
                </div>
                <div class="form-group">
                    <label for="chart_caption">Caption (차트 하단) </label>
                    <textarea class="form-control" rows="3" name="chart_caption" id="chart_caption"><?php echo $chart_caption; ?></textarea>
                </div>

                <input type="hidden" name="chart_type" id="chart_type" value="">
                <input type="hidden" name="plugin_www_url" id="plugin_www_url" value="<?php echo $plugin_www_url; ?>">
...
<script>
    $(document).ready(function () {
        ...
        var editor = ace.edit("chart_detailed_option");
